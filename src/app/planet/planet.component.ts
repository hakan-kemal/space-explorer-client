...
export class PlanetComponent implements OnInit {
  ...
  constructor(private iconService: IgxIconService) {
    this.iconService.addSvgIcon(
      "rain",
      "https://www.infragistics.com/angular-demos/assets/images/card/icons/rain.svg",
      "weather-icons"
    );
    this.iconService.addSvgIcon(
      "breeze",
      "https://www.infragistics.com/angular-demos/assets/images/card/icons/breeze.svg",
      "weather-icons"
    );
  }
  ...
  public ngOnInit() {
    this.cards = [
      new Card({
        ...
        imageUrl:
          "https://www.infragistics.com/angular-demos/assets/images/card/media/cafe.jpg",
      ...
      new Card({
        ...
        content: "37",
        imageUrl:
          "https://www.infragistics.com/angular-demos/assets/images/card/media/weather.png",
